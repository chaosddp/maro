...
class VehicleUnit(UnitBase):
    ...
    def register_data_model(frame: Frame):
        register = partial(frame.register_attr, VehicleUnit.data_model_name)

        register("id", AttrDataType.Int)
        register("facility_id", AttrDataType.Int)
        register("parent_id", AttrDataType.Int)

        register("position", AttrDataType.Int, 2)
        register("unit_transport_cost", AttrDataType.Int)
        register("requested_quantity", AttrDataType.Int)
        register("destination_id", AttrDataType.Int)
        register("source", AttrDataType.Int)
        register("patient", AttrDataType.Int)
        register("quantity", AttrDataType.Int)
        register("velocity", AttrDataType.Int)
        register("payload", AttrDataType.Int)
        register("steps", AttrDataType.Int)
