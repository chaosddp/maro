...
class ManufactureUnit(SkuUnit):
    ...
    def register_data_model(frame: Frame):
        register = partial(frame.register_attr, ManufactureUnit.data_model_name)
        ...
        register("output_units_per_lot", AttrDataType.Int)
        register("input_units_per_lot", AttrDataType.Int)
        register("manufacture_number", AttrDataType.Int)
        register("storage_id", AttrDataType.Int)
        register("product_unit_cost", AttrDataType.Int)
        register("production_rate", AttrDataType.Int)
